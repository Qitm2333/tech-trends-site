...
```
搜索查询模板：
1. "{厂商名} 发布 2026年{MM}月" - 逐个搜索必查厂商（搜索近两日，避免遗漏）
2. "AI大模型 最新发布 2026年{MM}月" 
3. "GitHub Trending 热门项目 2026年2月"
4. "机器之心 量子位 AI新闻 {MM}月"
```

⚠️ **重要提醒**：搜索时**不要限定具体日期**（如"2月20日"），应搜索**近两日**（如"2月"或"最近两天"），避免遗漏跨日发布的重要新闻。例如：
- ❌ 错误："OpenAI 发布 2026年2月20日"
- ✅ 正确："OpenAI 发布 2026年2月" 或 "OpenAI 最新发布"
...
**验证动作**：对每个厂商执行搜索，确认**近两日**（48小时）内是否有新发布

⚠️ **时间范围说明**：
- 搜索范围：**近两日**（昨天+今天）
- 原因：重要新闻可能在昨日晚间发布，今日才被广泛报道
- 示例：2月20日更新时，应搜索2月19日-20日的新闻
